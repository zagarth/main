...
<meta name="keywords" content="1970 gems ring, ladies jewelry, precious stones, Cadman Manufacturing" />
<link rel="icon" sizes="" href="../favicon.ico">
<title>1970 - Lady's Stoneset Collection | Cadman Manufacturing</title>
...
<body>
    ...
    $relatedImages = getRelatedImages('Gems', '1970.png');
    ?>
            ...
            <div class="item-images">
                ...
                <div class="thumbnail-gallery">
                    ...
                    <img src="Gems/<?php echo $relatedImage; ?>" 
                         ...
                         class="thumbnail<?php echo ($relatedImage === '1970.png') ? ' active' : ''; ?>"
