...
<meta name="keywords" content="1904 gems ring, ladies jewelry, precious stones, Cadman Manufacturing" />
<link rel="icon" sizes="" href="../favicon.ico">
<title>1904 - Lady's Stoneset Collection | Cadman Manufacturing</title>
...
<body>
    ...
    $relatedImages = getRelatedImages('Gems', '1904.png');
    ?>
            ...
            <div class="item-images">
                ...
                <div class="thumbnail-gallery">
                    ...
                    <img src="Gems/<?php echo $relatedImage; ?>" 
                         ...
                         class="thumbnail<?php echo ($relatedImage === '1904.png') ? ' active' : ''; ?>"
