...
<meta name="keywords" content="C223C_chocolatepearl_72dpi pearls ring, ladies jewelry, precious stones, Cadman Manufacturing" />
<link rel="icon" sizes="" href="../favicon.ico">
<title>C223C_chocolatepearl_72dpi - Lady's Stoneset Collection | Cadman Manufacturing</title>
...
<body>
    ...
    $itemName = 'C223C_chocolatepearl_72dpi';
    $category = 'pearls';
    $displayName = 'C223C Chocolatepearl 72dpi';
    $price = 1150;
    $categoryDisplay = 'Pearls';
    $description = 'Elegant pearl jewelry showcasing lustrous cultured and natural pearls';
    
    // Image paths
    $mainImage = 'Pearls/C223C_chocolatepearl_72dpi.jpg';
    $imagePath = $mainImage;
    ...
    $relatedImages = getRelatedImages('Pearls', 'C223C_chocolatepearl_72dpi.jpg');
    ?>
        ...
        <div class="item-detail-grid">
            ...
            <div class="item-images">
                ...
                <div class="thumbnail-gallery">
                    ...
                    <img src="Pearls/<?php echo $relatedImage; ?>" 
                         alt="<?php echo $displayName; ?>" 
                         class="thumbnail<?php echo ($relatedImage === 'C223C_chocolatepearl_72dpi.jpg') ? ' active' : ''; ?>"
                         onclick="changeMainImage('Pearls/<?php echo $relatedImage; ?>', this)">
                    <?php endforeach; ?>
                </div>
                <?php endif; ?>
            </div>
