...
<meta name="keywords" content="1902C pearls ring, ladies jewelry, precious stones, Cadman Manufacturing" />
<link rel="icon" sizes="" href="../favicon.ico">
<title>1902C - Lady's Stoneset Collection | Cadman Manufacturing</title>
...
<body>
    ...
    $relatedImages = getRelatedImages('Pearls', '1902C.png');
    ?>
            ...
            <div class="item-images">
                ...
                <div class="thumbnail-gallery">
                    ...
                    <img src="Pearls/<?php echo $relatedImage; ?>" 
                         ...
                         class="thumbnail<?php echo ($relatedImage === '1902C.png') ? ' active' : ''; ?>"
