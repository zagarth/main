...
<meta name="keywords" content="2280 gems ring, ladies jewelry, precious stones, Cadman Manufacturing" />
<link rel="icon" sizes="" href="../favicon.ico">
<title>2280 - Lady's Stoneset Collection | Cadman Manufacturing</title>
...
<body>
    ...
    $relatedImages = getRelatedImages('Gems', '2280.jpg');
    ?>
            ...
            <div class="item-images">
                ...
                <div class="thumbnail-gallery">
                    ...
                    <img src="Gems/<?php echo $relatedImage; ?>" 
                         ...
                         class="thumbnail<?php echo ($relatedImage === '2280.jpg') ? ' active' : ''; ?>"
