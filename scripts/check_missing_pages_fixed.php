...
// Database connection  
exec('sudo mysql -e "CREATE USER IF NOT EXISTS \'scanner\'@\'localhost\' IDENTIFIED BY \'scan123\'; GRANT ALL PRIVILEGES ON CadmanClients.* TO \'scanner\'@\'localhost\'; FLUSH PRIVILEGES;"');
...
try {
    ...
    foreach ($missingPages as $pdfFile) {
        ...
        echo "  Found product: $firstProduct\n";
        ...
        $success = $stmt->execute([
            ...
            'other',                // category (using allowed enum value)
            null,                   // pattern
            null,                   // style
