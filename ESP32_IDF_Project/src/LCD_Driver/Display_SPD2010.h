...
#define ESP_PANEL_LCD_SPI_CLK_HZ            (30 * 1000 * 1000)    // Reduced to 30MHz for stability
#define ESP_PANEL_LCD_SPI_TRANS_QUEUE_SZ    (10)                  // Restored to default
...
#define ESP_PANEL_HOST_SPI_MAX_TRANSFER_SIZE   (EXAMPLE_LCD_WIDTH * 5 * 2)  // 4120 bytes = 5 lines
...
void SPD2010_Reset(void);                // Hardware reset of SPD2010 display controller
void SPD2010_Init();
